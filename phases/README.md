...
One directory per curriculum phase. Each contains a `README.md` with the phase overview, plus `theory/` and/or `notebooks/` subdirectories as chapters get drafted.

Full curriculum in [`../CURRICULUM.md`](../CURRICULUM.md).
...
| VI | [phase-6-flow-matching-diffusion](./phase-6-flow-matching-diffusion/) | empty |
| VII | [phase-7-geometric-manifolds](./phase-7-geometric-manifolds/) | empty |
